...
const Cart = () => {
  ...
  return (
    <div className="w-full xl:max-w-screen-xl mx-auto py-10 xl:py-20 flex xl:flex-row flex-col">
      <CartItem />
      <div className="xl:w-1/3 w-full bg-[#fafafa] py-6 px-4">
        <div className="flex flex-col gap-6 border-b-[1px] border-b-gray-400 pb-6">
          ...
          <p className="flex items-start gap-4 text-base">
            Shipping <span>Momotaz Mosjid, 222/3, Dhaka, Bangladesh</span>
          </p>
        </div>
        <p>
